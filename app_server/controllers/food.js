...
var Homepage = function(req, res, responseBody){
    var message;
  ...
  module.exports.delete_food_menu = function(req, res){
  ...
  module.exports.make_create = function(req, res){
  ...
  module.exports.store_Item = function(req, res){
 ...
 module.exports.create_item_Data = function(req, res){
    var requestOptions, path;
    path = '/api/food';
    if (req.body.left_overs == 'on')
      req.body.left_overs = true;
